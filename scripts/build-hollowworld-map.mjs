/**
 * Paints Hollow World image.png from the shattered-planet art.
 *
 * Dark space (including gaps through the broken shell) → water 106 so ships
 * can fly around shards and into the hollow. Blue lakes stay water. Magma
 * core and lava rims stay volcanic land. Never emit #000000 walls.
 */
import fs from "fs";
...
const SRC = path.join(root, "map-generator/assets/maps/_hollowworld-color.png");
const OUT_DIR = path.join(root, "map-generator/assets/maps/hollowworld");
const SCALE = 2;
