/**
 * Paints Shattered image.png from the field of broken worlds.
 *
 * Dark space (including gaps through cracked shells) → water 106. Magma
 * cores stay volcanic land. Earth's-style oceans (blue touching green)
 * become lakes. Ice worlds stay land. Never emit #000000 walls.
 */
import fs from "fs";
...
const SRC = path.join(root, "map-generator/assets/maps/_shattered-color.png");
const OUT_DIR = path.join(root, "map-generator/assets/maps/shattered");
const SCALE = 2;
