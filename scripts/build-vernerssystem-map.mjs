/**
 * Paints Verners System image.png from the color planet-system art.
...
const SRC = path.join(root, "map-generator/assets/maps/_vernerssystem-color.png");
const OUT_DIR = path.join(root, "map-generator/assets/maps/vernerssystem");
const SCALE = 3;
