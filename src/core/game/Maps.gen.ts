...
export enum GameMapType {
  ...
  TwinIsles = "Twin Isles", // map-generator/assets/maps/twinisles/info.json
...
export const maps: readonly MapInfo[] = [
  ...
  {
    id: "TwinIsles",
    type: GameMapType.TwinIsles,
    translationKey: "map.twinisles",
    categories: ["new", "fictional"],
    multiplayerFrequency: 4,
    ffaFrequency: -1,
    teamFrequency: -1,
