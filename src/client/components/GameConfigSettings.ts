...
const unitOptions: { type: UnitType; translationKey: string }[] = [
  ...
  { type: UnitType.Starport, translationKey: "unit_type.starport" },
  { type: UnitType.PortGun, translationKey: "unit_type.port_gun" },
  ...
  { type: UnitType.Lander, translationKey: "unit_type.lander" },
