...
export class UserSettingModal extends BaseModal {
  ...
  private renderKeybindSettings() {
    return html`
      ...
      <setting-keybind
        action="buildPortGun"
        label=${translateText("user_setting.build_port_gun")}
        description=${translateText("user_setting.build_port_gun_desc")}
        defaultKey=${this.defaultKeybinds.buildPortGun}
        .value=${this.getKeyValue("buildPortGun")}
        .display=${this.getKeyChar("buildPortGun")}
        @change=${this.handleKeybindChange}
      ></setting-keybind>

      <setting-keybind
        action="buildInlandBattery"
        label=${translateText("user_setting.build_inland_battery")}
        description=${translateText("user_setting.build_inland_battery_desc")}
        defaultKey=${this.defaultKeybinds.buildInlandBattery}
        .value=${this.getKeyValue("buildInlandBattery")}
        .display=${this.getKeyChar("buildInlandBattery")}
        @change=${this.handleKeybindChange}
      ></setting-keybind>
